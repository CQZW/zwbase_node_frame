        ...
        try
        {
            do
            {
                ...
                {//收到了广播节点的数据
                    ...
                    {
                        recvpeer = new ZWPeer();
                        this._remote_peers[recvpeer.ip] = recvpeer;
                    }
                ...
                {//收到了 从进程获取所有节点的请求
                    if( !this._isMain ) break;
                    this._local_peers[rinfo.port] = recvdata;
