...
class ZWBaseSrv
{
    ...
    {
        if( this._cfg.canRPC && forceRob ) logger.log('maybe has some error');
    ...
    async peermgr_ipc_data( recvobj )
    {
        ...
        {//IPC 之间的 RPC 调用
            ...
            return this._rpcpeermgr.resbDataIPC( recvobj.ack , null , '无法响应的IPC-RPC请求:'+ rpcdata.func_unique_id );
        }
        return this._rpcpeermgr.resbDataIPC( recvobj.ack ,null ,'无法响应IPC请求' );
    }
